...
- DATA-016 — bulk HCPA parcel-catalog ingestion (downloads.hcpafl.org),
  scoped 2026-07-28 per DATA-015D's ~1.41% coverage finding; first step is
  a non-mutating source-probe of the parcel XLS/ZIP file's real schema.
  (DATA-015D's smaller checkpoint-persistence recommendation was fixed
  same-day, 2026-07-28 — see DATA-016's own registry row.)
