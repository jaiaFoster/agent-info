...
- Bulk parcel-catalog ingestion (per DATA-015D's finding: ~1.41% of the
  527,882-parcel Hillsborough catalog is ingested; recommends HCPA's
  downloads.hcpafl.org bulk-file portal over continued page-at-a-time
  DATA-006L/OPS-AUTO-002 pagination) — not yet a numbered ticket.
